...
export class TxMessageTypeLabelPipe implements PipeTransform {
  ...
  public readonly messageTypeLabelMap: Record<TxMessageTypeUrl, string> = {
    ...
    [TxMessageTypeUrl.IbcMsgAcknowledgement]: 'IBC Acknowledgement',
    [TxMessageTypeUrl.IbcMsgTransfer]: 'IBC Transfer',
    [TxMessageTypeUrl.IbcMsgUpdateClient]: 'IBC Update Client',
